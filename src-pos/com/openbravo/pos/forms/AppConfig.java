...
public class AppConfig implements AppProperties {
    ...
    private void loadDefault() {
        ...
        String sSoftwareInstall = m_propsconfig.getProperty("software.install");
...
//        m_propsconfig.setProperty("db.driverlib", new File(new File(dirname), "lib/jdbc/hsqldb.jar").getAbsolutePath());
...
//        m_propsconfig.setProperty("db.password", "password");
        ...
        if (sSoftwareInstall != null) {
            m_propsconfig.setProperty("software.install", sSoftwareInstall);
        }

//        } else {
//            m_propsconfig.setProperty("software.install", ValidationKey.generateInstallDate());
//        }
